...
public class OrderTests
{
    ...
    {
        var order = Order.Create(ValidUserId, "John Doe", "john@example.com", ValidItems);
    ...
    {
        Assert.Throws<ArgumentException>(() => Order.Create(ValidUserId, "John Doe", "john@example.com", []));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() => Order.Create(ValidUserId, customerName!, "john@example.com", ValidItems));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() => Order.Create(ValidUserId, "John Doe", customerEmail, ValidItems));
    }
    ...
    public void Create_WithZeroQuantity_Throws()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => Order.Create(ValidUserId, "John Doe", "john@example.com", items));
    }
